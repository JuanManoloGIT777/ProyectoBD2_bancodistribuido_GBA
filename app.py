...
def crear_usuario_admin():
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Usuarios",
            "REGISTRO_USUARIO",
            f"El administrador {session['usuario']} registró al usuario interno {usuario}."
        )
...
def inactivar_usuario_admin(id_usuario):
    ...
    try:
        ...
        registrar_auditoria(
            ...
            f"El administrador {session['usuario']} inactivó al usuario {usuario['usuario']}."
        )
...
def activar_usuario_admin(id_usuario):
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Usuarios",
            "ACTIVACION_USUARIO",
            f"El administrador {session['usuario']} activó al usuario {usuario['usuario']}."
        )
...
def inactivar_cliente_admin(id_cliente):
    ...
    try:
        ...
        registrar_auditoria(
            ...
            f"El administrador {session['usuario']} inactivó al cliente {cliente['nombres']} {cliente['apellidos']}."
        )
...
def activar_cliente_admin(id_cliente):
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Clientes",
            "ACTIVACION_CLIENTE",
            f"El administrador {session['usuario']} activó al cliente {cliente['nombres']} {cliente['apellidos']}."
        )
...
def inactivar_cuenta_admin(id_cuenta):
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Cuentas",
            "INACTIVACION_CUENTA",
            f"El administrador {session['usuario']} inactivó la cuenta {cuenta['numero_cuenta']}."
        )
...
def activar_cuenta_admin(id_cuenta):
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Cuentas",
            "ACTIVACION_CUENTA",
            f"El administrador {session['usuario']} activó la cuenta {cuenta['numero_cuenta']}."
        )
...
def guardar_cliente():
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Clientes",
            "INSERT",
            f"El cajero {session['usuario']} registró al cliente {nombres} {apellidos} con DPI {dpi}."
        )
...
def guardar_cuenta():
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Cuentas",
            "INSERT",
            f"El cajero {session['usuario']} creó la cuenta {numero_cuenta}."
        )
...
def procesar_transaccion():
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Transacciones",
            "TRANSACCION",
            f"El cajero {session['usuario']} procesó una transacción {tipo} por Q{monto:.2f}."
        )
...
def anular_transaccion():
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Transacciones",
            "ANULACION",
            f"El cajero {session['usuario']} anuló la transacción {transaccion['codigo_transaccion']} por Q{monto:.2f}."
        )
...
def procesar_pago():
    ...
    try:
        ...
        registrar_auditoria(
            ...
            "Pagos",
            "INSERT",
            f"El cajero {session['usuario']} registró un pago de servicio por Q{monto:.2f}."
        )
